...
import { ArrowUpLeft, Phone, Mail, ArrowUp } from "lucide-react";

const QUICK_LINKS = [
  { label: "خانه", href: "/" },
  { label: "درباره وکیل", href: "/#aboutUs" },
  { label: "خدمات حقوقی", href: "/#services" },
  { label: "سوابق و پرونده‌ها", href: "/#cases" },
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
            ...
            <div>
              ...
              <h2 className="max-w-2xl text-2xl font-bold leading-[1.8] text-white md:text-4xl">
                ...
                <span className="text-[#b08d57]">
                  {" "}
                  از مشاوره حقوقی بهره بگیرید.
                </span>
              </h2>

              <p className="mt-3 max-w-xl text-sm leading-7 text-white/45">
                بررسی دقیق موضوع، ارائه راهکار حقوقی و همراهی حرفه‌ای در مسیر
                پیگیری حقوق شما.
              </p>
            </div>
        ...
        {/* Main Footer Wrapper (اصلاح شده) */}
        <div className="grid gap-12 py-14 md:grid-cols-2 lg:grid-cols-12 lg:gap-10">
          {/* Brand */}
          <div className="lg:col-span-4">
            <Link href="/" className="group inline-flex items-center gap-4">
              <div
                className="relative flex h-14 w-14 shrink-0 items-center 
              justify-center overflow-hidden transition-all duration-300 group-hover:border-[#b08d57] group-hover:bg-[#b08d57]/20"
              >
                <Image
                  src="/logos/mainLogo.jfif"
                  alt="لوگوی وکیل نصیری"
                  fill
            ...
            <p className="mt-7 max-w-sm text-sm leading-8 text-white/45">
              ارائه خدمات مشاوره و وکالت در امور حقوقی و قضایی با رویکردی دقیق،
              مسئولانه و متعهدانه؛ با هدف صیانت از حقوق و منافع موکلان.
            </p>
          </div>
          ...
          {/* Contact */}
          <div className="lg:col-span-3">
            <h3 className="mb-6 text-sm font-bold text-white">اطلاعات تماس</h3>
